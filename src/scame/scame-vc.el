...
(use-package magit
  ...
  :config (progn
            ...
            (pretty-magit "Close"     ? (:foreground "#375E97" :height 1.2))
            (pretty-magit "Close"     ? (:foreground "#375E97" :height 1.2) t)
            (pretty-magit "Cut"       ? (:foreground "#375E97" :height 1.2))
            (pretty-magit "Update"    ? (:foreground "#375E97" :height 1.2))
            (pretty-magit "Update"    ? (:foreground "#375E97" :height 1.2) t)
            (pretty-magit "Bump"      ? (:foreground "#375E97" :height 1.2))
