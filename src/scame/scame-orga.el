...
(use-package time
  :ensure nil
  :defer t
  :init (add-hook 'after-init-hook 'display-time t)
  :config
  (progn
...
(use-package diary
  ...
  :config
  (progn
    (setq diary-file (f-join user-home-directory ".diary"))
...
(when scame-org
  ...
  (use-package calfw-ical
    ...
    :pin melpa
    :defer t
    :config (setq google-ical-calendar nil))
